...
func init() {
	core.InstallPlugin[SagooPlugin](core.PluginMeta{
		Name: "Sagoo",
		Title: map[string]string{
			"en": "Sagoo IoT Platform",
			"zh": "Sagoo 物联网平台",
		},
		Description: map[string]string{
			"en": "Uplink plugin for Sagoo IoT Platform via MQTT",
			"zh": "通过 MQTT 接入 Sagoo 物联网平台",
		},
		Category: "platform",
		DefaultYaml: `
enable_tls: false
...
func (p *SagooPlugin) Init(ctx platform.Context) error {
	...
	// Register API
	if err := ctx.RegisterHTTPHandler("/api/extension/sagoo/status", p.API_Status); err != nil {
...
func (p *SagooPlugin) PushData(data *platform.DataModel) error {
